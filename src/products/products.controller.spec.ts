...
describe('ProductsController', () => {
  ...
  describe('Public Endpoints', () => {
    it('should have public endpoints', () => {
      expect(typeof controller.getProductsPublic).toBe('function');
      expect(typeof controller.searchProducts).toBe('function');
      expect(typeof controller.getProductsByCategory).toBe('function');
      expect(typeof controller.getProductBySlug).toBe('function');
    });
  });
});
